...
export let allShows = async (req: Request, res: Response) => {
...
export let addShow = async (req: Request, res: Response) => {
...
export let deleteShow = async (req: Request, res: Response) => {
  const showId = req.params.id;
  if (mongoose.Types.ObjectId.isValid(showId)) {
...
export let updateShow = async (req: Request, res: Response) => {
